    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <footer className="py-12 bg-card border-t border-border mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 pt-8 border-t border-border text-center">
            <p className="text-md text-muted-foreground">© {new Date().getFullYear()} Freedom Team Trading. All rights reserved.</p>
          </div>
        </div>
      </footer>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-2xl font-serif font-bold text-center">Book Your Free Strategy Session</DialogTitle>
          </DialogHeader>
          ...
          <div className="relative w-[90%] sm:w-[85%] lg:w-[80%] max-w-[1100px] bg-card border border-border rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200 animate-subtle-shake">
            ...
            <div className="p-8 space-y-6">
              <div className="space-y-2 text-center">
                <h2 id="exit-intent-title" className="font-serif font-black text-3xl text-card-foreground">
                  Don't Miss Out!
                </h2>
                <p className="text-lg text-muted-foreground m-0">
                  Schedule your free strategy session today & receive a FREE eBook:
                  <br />
                  <span className="font-semibold text-muted-foreground text-3xl">THE OPTIONS SCANNER BLUEPRINT</span>
                </p>
                <p className="text-md text-muted-foreground">
                  Rare, insider-level strategies to find winning 1,000% options plays... before they take off
                </p>
              </div>
              <div className="space-y-4 text-md text-black bg-gray-300 p-5 rounded-xl font-semibold">
                <p className="font-black text-lg">Here's what you'll get inside:</p>
                <ul className="list-disc pl-5 grid sm:grid-cols-2 gap-x-8 gap-y-2">
                  <li className="pr-4">The exact scan settings we use every day to find bullish and bearish setups in seconds</li>
                  <li className="pr-4">How to filter out 90% of “noise” stocks so you only see plays with strong potential</li>
                  <li className="pr-4">When and why to flip the scan for bear setups that can deliver just as much upside</li>
                  <li className="pr-4">A simple chart review process to confirm entries in under 30 minutes a day</li>
                  <li className="pr-4">How to pair your scans with options volume checks to avoid costly mistakes</li>
                  <li className="pr-4">The method we’ve refined over years of trading that works for accounts big or small</li>
                </ul>
                <p className="text-black text-md">
                  This is not theory… it’s our real, day-to-day scan process, broken down so you can start using it immediately.
                  And right now, when you book your free 1-on-1 strategy session, you’ll get it instantly as a bonus.
                </p>
              </div>
